...
(function (root, factory) {
  ...
  function processUserQuery(textOrObj, languageArg, barrierContextArg, sessionIdArg, options = {}) {
    ...
    if (barrierContextInput) {
      const bName = typeof barrierContextInput === 'object' ? (barrierContextInput.barrier || barrierContextInput.key) : barrierContextInput;
      const normalizedKey = BarrierSelector.normalizeBarrierKey(bName);
      if (normalizedKey) {
